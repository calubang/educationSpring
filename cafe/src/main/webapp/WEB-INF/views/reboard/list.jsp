...
$(function() {
	...
	$(".viewBtn").click(function() {
		...
		$("#boardCommonForm").attr("method", "get").attr("action", "${root}/reboard/view").submit();
	});
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr valign="bottom">
		<td nowrap><img
			...
			border="0" align="absmiddle" alt="글쓰기" class="moveWriteBtn"></td>
...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
	...
	<tr>
		...
		<td style="word-break: break-all;"><label class="viewBtn" data-seq="${article.seq}">
		<c:forEach begin="1" end="${article.lev}" step="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</c:forEach>
			${article.subject.replace('<', '&lt;')}&nbsp;&nbsp;&nbsp;</label></td>
		<td></td>
		...
		<td nowrap>
			...
			<c:if test="${!empty sessionScope.userInfo}">
				<img src="${root}/img/board/sbtn_mytext.gif" width="82" height="20"
					align="absmiddle" alt="내가 쓴 글 보기" id="myListBtn">
			</c:if>
			<br>
		</td>
