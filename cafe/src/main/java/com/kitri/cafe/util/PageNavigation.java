...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		if (this.isNowFirst()) {
			...
			tmpNavigator.append("   <img src='" + root + "/img/board/icon_prev02.gif' width='7' height='11' border='0' align='absmiddle' hspace='3'>최신목록\n");
		...
		int endPage =  (prePage + pageSize) >= totalPageCount ? totalPageCount : prePage + pageSize;
		
		for (int i = startPage; i <= endPage; i++) {
			if (pageNo == i) {
				tmpNavigator.append("     <td style='padding:0px 7px 0px 7px;' nowrap><font class='text_acc_02'><b>" + i + "</b></font></td>\n");
				tmpNavigator.append("     <td width='1' nowrap><img src='" + root + "/img/board/n_tab.gif' width='1'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			} else {
				tmpNavigator.append("     <td style='padding:0px 7px 0px 7px;' nowrap><label class='moveListBtn' data-pg='" + ( i ) + "'>" + i + "</label></td>\n");
				tmpNavigator.append("     <td width='1' nowrap><img src='" + root + "/img/board/n_tab.gif' width='1'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			}
		}
	...
	public String toString() {
		return "PageNavigation [root=" + root + ", nowFirst=" + nowFirst + ", nowEnd=" + nowEnd + ", totalArticleCount="
				+ totalArticleCount + ", newArticleCount=" + newArticleCount + ", totalPageCount=" + totalPageCount
				+ ", pageNo=" + pageNo + ", navigator=" + navigator + "]";
	}
}
